...
*/
	...
	if ( isset( $_POST['disp_filter'] ) ) {
        ...
        $disp_filter = ipv_db_escape_string( $disp_filter );
		$filter_str .= ' AND ipv_int_disp_reason=\'' . $disp_filter . '\' ';
	}

	if ( isset( $_POST['category_filter'] ) ) {
		$category_filter = $_POST['category_filter'];
        $category_filter = ipv_db_escape_string( $category_filter );
		$filter_str .= <<<EOQ
			AND ( 
